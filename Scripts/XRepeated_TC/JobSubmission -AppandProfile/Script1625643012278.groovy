...
try {
	...
	WebUI.verifyElementPresent(findTestObject('Object Repository/JobSubmissionForm/Shellscript'), 3)
	
	WebUI.verifyElementPresent(findTestObject('Object Repository/JobSubmissionForm/GenericProfile'), 3)
	
	WebUI.rightClick(findTestObject('JobMonitoringPage/MultiFolders'))
	
	WebUI.verifyElementAttributeValue(findTestObject('Object Repository/JobSubmissionForm/JobScript'), 'class', 'isContextMenuDisabled', 20)
