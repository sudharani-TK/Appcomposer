...
WebUI.rightClick(findTestObject('SessionsTab/Gedit_RowItem'))

WebUI.delay(2)

WebUI.click(findTestObject('SessionsTab/ContextMenu_Open'))
...
WebUI.click(findTestObject('SessionsTab/ContextMenu__Terminate'))
